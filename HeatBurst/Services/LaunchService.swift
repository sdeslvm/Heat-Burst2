...
private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "HeatBurst", category: "LaunchService")
...
final class LaunchService {
    ...
    private let stubURL = URL(string: "https://heatburstix.pro/play")!
